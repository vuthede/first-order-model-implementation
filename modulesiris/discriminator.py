...
from modulesiris.util import kp2gaussian
import torch
...
if __name__ == '__main__':
    ...
    out = D(x)
    # out[0]:len==4. Include 4 intermediate group of feature maps. 
    # out[1]: Bx1x26x26: The score mask which say fake or real
